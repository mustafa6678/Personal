            ...
            <div className="lg:col-span-5 relative">
              <div className="relative aspect-square rounded-[3rem] overflow-hidden border-[12px] border-gray-50 shadow-2xl">
                <Image
                  ...
                  alt="Technician repairing an iPhone screen at The Phone Shop Express workbench in Preston"
                  fill
                  priority
            ...
            <div className="lg:col-span-7">
              <div className="rounded-[3rem] overflow-hidden border-[12px] border-white/5 shadow-2xl">
                <Image
                  ...
                  alt="Certified refurbished iPhone and Samsung smartphones for sale in Preston"
                  width={1000}
                  height={1000}

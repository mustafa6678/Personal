            ...
            <div className="lg:col-span-5 p-16 bg-white border border-gray-100 rounded-[4rem] flex flex-col justify-between hover:border-primary/20 transition-colors">
              ...
              <div className="mt-20 pt-10 border-t border-gray-50">
                ...
                <div className="flex gap-6">
                  <a href={siteConfig.social.facebook} target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-gray-50 rounded-xl flex items-center justify-center hover:bg-primary hover:text-white transition-all text-gray-400">
                    <Facebook className="w-5 h-5" />
                  </a>
                  <a href={siteConfig.social.instagram} target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-gray-50 rounded-xl flex items-center justify-center hover:bg-primary hover:text-white transition-all text-gray-400">

        ...
        <Container>
          <div className="max-w-4xl">
            ...
            <div className="flex flex-wrap gap-4">
              <Button href="/contact" size="lg" className="rounded-full px-12">Open Account</Button>
              <Button href="/contact" variant="outline" size="lg" className="rounded-full px-12">Talk to Sales</Button>
            </div>
          </div>
        </Container>
      </section>
      ...
      <section className="py-24 bg-white">
        <Container>
          <div className="bg-gray-50 rounded-[3rem] p-12 md:p-24 text-center">
            ...
            <Button href="/contact" size="lg" className="rounded-full px-16">Contact Business Team</Button>
          </div>
        </Container>
      </section>
    </main>
